...
We obtain 19306 and 18811 galaxies for spiral and elliptical respectively. Then we \todo{split}{explain further more about how we split the data} the data into three sets for training, validation and testing. The number of each class for each set is shown in Table~\ref{tab:dataset}.
\begin{table}[]
	\centering
	\begin{tabular}{@{}ccccc@{}}
		\toprule
